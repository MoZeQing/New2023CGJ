...
namespace GameMain
{
    public class ClosetForm : BaseForm
    {
        ...
        private void Init()
        {
            ...
            closetItems[2].transform.GetChild(1).gameObject.SetActive(GameEntry.Cat.Closet==dRItems[0].Id);
            ...
            closetItems[3].transform.GetChild(1).gameObject.SetActive(GameEntry.Cat.Closet == dRItems[1].Id);
            ...
            closetItems[1].transform.GetChild(1).gameObject.SetActive(GameEntry.Cat.Closet == dRItems[dRItems.Count - 1].Id);
        ...
        private void Right()
        {
            ...
            closetItems[1].transform.GetChild(1).gameObject.SetActive(GameEntry.Cat.Closet== dRItems[(index + dRItems.Count - 1) % dRItems.Count].Id);
            ...
            closetItems[2].transform.GetChild(1).gameObject.SetActive(GameEntry.Cat.Closet == dRItems[index].Id);
            ...
            closetItems[3].transform.GetChild(1).gameObject.SetActive(GameEntry.Cat.Closet == dRItems[(index + dRItems.Count + 1) % dRItems.Count].Id);
